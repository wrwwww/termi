...
// use crate::app::settings::merge_from::MergeFrom;

use serde::{Deserialize, Serialize};
use utils::collections::HashMap;

use crate::theme::{FontFamilyName, FontFeaturesContent, FontSize, FontWeightContent};
...
#[derive(
    Clone, Debug, Default, Serialize, Deserialize, PartialEq, Eq, strum::EnumDiscriminants,
)]
...
#[derive(Clone, Debug, Serialize, Deserialize, PartialEq, Eq, strum::EnumDiscriminants)]
#[strum_discriminants(derive(strum::VariantArray, strum::VariantNames, strum::FromRepr))]
#[serde(rename_all = "snake_case")]
...
pub enum TerminalLineHeight {
    ...
    Custom(
        #[serde(serialize_with = "crate::serde_helper::serialize_f32_with_two_decimal_places")] f32,
    ),
}
