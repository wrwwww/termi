...
use crate::{color::Color, typography::StyledTypography};
...
impl LabelCommon for LabelLike {
    ...
    fn buffer_font(mut self, cx: &App) -> Self {
        let font = theme_settings::theme_settings(cx).buffer_font(cx).clone();
    ...
    fn inline_code(mut self, cx: &App) -> Self {
        self.base = self
            .base
            .font(theme_settings::theme_settings(cx).buffer_font(cx).clone())
...
impl RenderOnce for LabelLike {
    fn render(self, _window: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        self.base
            ...
            .font_weight(
                self.weight
                    .unwrap_or(theme_settings::theme_settings(cx).ui_font(cx).weight),
            )
